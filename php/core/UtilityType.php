...
// UrlShortener SDK utility type

class UrlShortenerUtility
{
    ...
    public static function copy(UrlShortenerUtility $src): UrlShortenerUtility
    {
        $u = new UrlShortenerUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
