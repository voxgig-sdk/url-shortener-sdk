...
// UrlShortener SDK proxy feature
...
class UrlShortenerProxyFeature extends UrlShortenerBaseFeature
{
    ...
    public function init(UrlShortenerContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UrlShortenerContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
