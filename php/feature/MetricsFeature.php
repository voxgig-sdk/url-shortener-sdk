...
// UrlShortener SDK metrics feature
...
class UrlShortenerMetricsFeature extends UrlShortenerBaseFeature
{
    ...
    private function _record(UrlShortenerContext $ctx, bool $ok): void
    {
