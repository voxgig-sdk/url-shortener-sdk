...
// UrlShortener SDK idempotency feature
...
class UrlShortenerIdempotencyFeature extends UrlShortenerBaseFeature
{
    ...
    private function _mutating(UrlShortenerContext $ctx): bool
    {
