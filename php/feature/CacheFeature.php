...
// UrlShortener SDK cache feature
...
class UrlShortenerCacheFeature extends UrlShortenerBaseFeature
{
    ...
    private function _through(UrlShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
