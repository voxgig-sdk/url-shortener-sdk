...
// UrlShortener SDK netsim feature
...
class UrlShortenerNetsimFeature extends UrlShortenerBaseFeature
{
    ...
    private function _simulate(UrlShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UrlShortenerContext $ctx, array $applied): void
    {
        $client = $this->client;
