...
// UrlShortener SDK clienttrack feature
...
class UrlShortenerClienttrackFeature extends UrlShortenerBaseFeature
{
    ...
    public function PostConstruct(UrlShortenerContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UrlShortener-SDK';
