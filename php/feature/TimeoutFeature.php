...
// UrlShortener SDK timeout feature
...
class UrlShortenerTimeoutFeature extends UrlShortenerBaseFeature
{
    ...
    private function _with_timeout(UrlShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UrlShortenerContext $_ctx, float $ms): void
    {
        $client = $this->client;
