...
class IndexEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set URL_SHORTENER_TEST_INDEX_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function index_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("URL_SHORTENER_TEST_INDEX_ENTID");
