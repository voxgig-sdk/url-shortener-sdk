...
// UrlShortener SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UrlShortenerSDK::test)
...
{
    private const SDK_CLASS = 'UrlShortenerSDK';
    ...
    private const SDK_BASE = 'urlshortener_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../urlshortener_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
