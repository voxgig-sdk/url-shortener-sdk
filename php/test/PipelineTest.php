...
// UrlShortener SDK pipeline test
//
...
{
    private static function utility(): UrlShortenerUtility
    {
        return new UrlShortenerUtility();
    }
    ...
    private static function ctx(array $over = []): UrlShortenerContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new UrlShortenerContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new UrlShortenerOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof UrlShortenerError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new UrlShortenerOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = UrlShortenerMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new UrlShortenerOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = UrlShortenerMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new UrlShortenerOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = UrlShortenerMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UrlShortenerSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = UrlShortenerMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new UrlShortenerResponse([]),
            'result' => new UrlShortenerResult([]),
        ]);
        [, $err] = UrlShortenerMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new UrlShortenerSpec([]),
            'response' => null,
            'result' => new UrlShortenerResult([]),
        ]);
        [, $err] = UrlShortenerMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new UrlShortenerSpec(['step' => 's']),
            'response' => new UrlShortenerResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new UrlShortenerResult([]),
        ]);
        [, $err] = UrlShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new UrlShortenerSpec(['step' => 's']),
            'response' => new UrlShortenerResponse(self::resp(200, ['v' => 1])),
            'result' => new UrlShortenerResult([]),
        ]);
        [, $err] = UrlShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new UrlShortenerSpec(['step' => 's']),
            'response' => new UrlShortenerResponse(self::resp(200, ['v' => 2])),
            'result' => new UrlShortenerResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        UrlShortenerMakeResponse::call($ctx);
    ...
    {
        $preset = new UrlShortenerResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new UrlShortenerSpec([]),
            'response' => new UrlShortenerResponse([]),
            'result' => new UrlShortenerResult([]),
        ...
        [$got, $err] = UrlShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new UrlShortenerResult([])]);
        [, $err] = UrlShortenerMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new UrlShortenerSpec([]), 'result' => null]);
        [, $err] = UrlShortenerMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UrlShortenerSpec(['step' => 's']),
            'result' => new UrlShortenerResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new UrlShortenerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UrlShortenerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UrlShortenerSpec(['step' => 's']),
            'result' => new UrlShortenerResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new UrlShortenerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UrlShortenerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UrlShortenerResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new UrlShortenerSpec([]),
            'result' => new UrlShortenerResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = UrlShortenerMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UrlShortenerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new UrlShortenerError('boom', 'boom');
        $utility->fetcher = function (UrlShortenerContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UrlShortenerSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = UrlShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (UrlShortenerContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = UrlShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(UrlShortenerResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        UrlShortenerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (UrlShortenerContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UrlShortenerSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = UrlShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new UrlShortenerResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new UrlShortenerSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = UrlShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = UrlShortenerMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = UrlShortenerMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new UrlShortenerResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, UrlShortenerDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new UrlShortenerResult(['ok' => false])]);
        $this->expectException(UrlShortenerError::class);
        UrlShortenerDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new UrlShortenerResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', UrlShortenerMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        UrlShortenerMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new UrlShortenerBaseFeature();
        $b = new UrlShortenerBaseFeature();
        UrlShortenerFeatureAdd::call($ctx, $a);
        UrlShortenerFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): UrlShortenerBaseFeature
    {
        $f = new UrlShortenerBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        UrlShortenerFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): UrlShortenerContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new UrlShortenerSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UrlShortenerPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        UrlShortenerPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new UrlShortenerResponse(['headers' => null]),
            'result' => new UrlShortenerResult([]),
        ]);
        UrlShortenerResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        UrlShortenerResultBody::call($ctx);
