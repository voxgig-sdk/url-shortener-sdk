...
// UrlShortener SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UrlShortenerOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UrlShortenerOmni::structfix($now, Struct::undef()))
                        !== json_encode(UrlShortenerOmni::structfix($val, Struct::undef()))) {
