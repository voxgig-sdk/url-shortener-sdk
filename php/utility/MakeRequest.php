...
// UrlShortener SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class UrlShortenerMakeRequest
{
    public static function call(UrlShortenerContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new UrlShortenerResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new UrlShortenerResponse($fetched);
        } else {
