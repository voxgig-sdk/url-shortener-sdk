...
// UrlShortener SDK utility: fetcher

class UrlShortenerFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UrlShortenerSDK/1.0)';
    ...
    public static function call(UrlShortenerContext $ctx, string $fullurl, array $fetchdef): array
    {
