...
// UrlShortener SDK utility: graphql
//
...
class UrlShortenerGraphql
{
    ...
    // equivalent.
    public static function body(UrlShortenerContext $ctx): mixed
    {
    ...
    public static function errors(UrlShortenerContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
