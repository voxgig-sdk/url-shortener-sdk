...
// UrlShortener SDK utility: make_options

class UrlShortenerMakeOptions
{
    ...
    public static function call(UrlShortenerContext $ctx): array
    {
        ...
        //
        // `UrlShortenerSchema::optspec()` is built from the model:
        ...
        $optspec = UrlShortenerSchema::optspec();
