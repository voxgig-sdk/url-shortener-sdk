# UrlShortener PHP SDK Reference

Complete API reference for the UrlShortener PHP SDK.
...
#### `UrlShortenerSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): UrlShortenerUtility`
...
```php
$result = $client->Index()->load(["url" => "url"]);
```
