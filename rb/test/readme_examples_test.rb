...
#      offline in seeded test mode (UrlShortenerSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "UrlShortener_sdk.rb")
  SDK_CLASS = "UrlShortenerSDK"
