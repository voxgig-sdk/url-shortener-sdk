...
|---|---|---|
| `ts/` | @voxgig-sdk/url-shortener-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/url-shortener-sdk \
      --repository voxgig-sdk/url-shortener-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/url-shortener-sdk` shows it, and
`npm trust revoke @voxgig-sdk/url-shortener-sdk --id=<id>` removes it.
