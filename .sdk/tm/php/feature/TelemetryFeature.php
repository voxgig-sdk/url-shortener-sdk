...
// UrlShortener SDK telemetry feature
...
class UrlShortenerTelemetryFeature extends UrlShortenerBaseFeature
{
    ...
    private function _close(UrlShortenerContext $ctx, bool $ok): void
    {
