...
// UrlShortener SDK streaming feature
...
class UrlShortenerStreamingFeature extends UrlShortenerBaseFeature
{
    ...
    private function _iterate(UrlShortenerResult $result): \Generator
    {
    ...
    private function _streamable(UrlShortenerContext $ctx): bool
    {
