...
class UrlShortenerRbacFeature extends UrlShortenerBaseFeature
{
    ...
    private function _required(UrlShortenerContext $ctx): ?string
    {
    ...
    private function _reject(UrlShortenerContext $ctx, string $required): void
    {
    ...
    private function _track(UrlShortenerContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
