...
// UrlShortener SDK ratelimit feature
...
class UrlShortenerRatelimitFeature extends UrlShortenerBaseFeature
{
    ...
    private function _acquire(UrlShortenerContext $ctx): void
    {
    ...
    private function _track(UrlShortenerContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
