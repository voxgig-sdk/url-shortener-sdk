...
// UrlShortener SDK audit feature
...
class UrlShortenerAuditFeature extends UrlShortenerBaseFeature
{
    ...
    private function _emit(UrlShortenerContext $ctx, string $outcome): void
    {
