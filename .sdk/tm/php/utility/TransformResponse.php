...
// UrlShortener SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class UrlShortenerTransformResponse
{
    public static function call(UrlShortenerContext $ctx): mixed
    {
        ...
        $transform = UrlShortenerHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
