...
class UrlShortenerTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UrlShortenerTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UrlShortenerTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UrlShortenerTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
