...
class UrlShortenerTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UrlShortenerTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = UrlShortenerTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = UrlShortenerTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
