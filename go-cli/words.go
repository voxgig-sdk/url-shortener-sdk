...
func registerSDKWords(r *eng.Registry, client *sdk.UrlShortenerSDK) {
...
func runOp(client *sdk.UrlShortenerSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
