...
function envOverride(m) {
    if ('TRUE' === process.env.URL_SHORTENER_TEST_LIVE ||
        'TRUE' === process.env.URL_SHORTENER_TEST_OVERRIDE) {
    ...
    m.URL_SHORTENER_TEST_EXPLAIN = process.env.URL_SHORTENER_TEST_EXPLAIN || m.URL_SHORTENER_TEST_EXPLAIN;
    return m;
}
