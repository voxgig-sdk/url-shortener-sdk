...
(0, node_test_1.describe)('IndexDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('URL_SHORTENER_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.UrlShortenerSDK({
...
function liveScenariosActive() { return false && process.env.URL_SHORTENER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UrlShortenerSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['URL_SHORTENER_TEST_INDEX_ENTID'];
    ...
    const client = new __1.UrlShortenerSDK({
        base: 'http://localhost:8080',
