...
(0, node_test_1.describe)('IndexEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.UrlShortenerSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.UrlShortenerSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.UrlShortenerSDK(merge([
