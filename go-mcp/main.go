// Command UrlShortener-mcp is an MCP server exposing the UrlShortener
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UrlShortener_list  — list records of an entity
//	UrlShortener_load  — load a single record of an entity
//
