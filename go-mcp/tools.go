...
type Args struct {
	Entity string         `json:"entity" jsonschema:"index"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UrlShortenerSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "url-shortener_list",
		Description: "List records from UrlShortener. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "url-shortener_load",
		Description: "Load a single record from UrlShortener. " +
...
func runOp(client *sdk.UrlShortenerSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UrlShortenerSDK, name string) (sdk.UrlShortenerEntity, error) {
