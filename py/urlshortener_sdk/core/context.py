...
from urlshortener_sdk.core.helpers import get_ctx_prop, to_map
...
class UrlShortenerContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, UrlShortenerSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UrlShortenerResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UrlShortenerResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return UrlShortenerError(code, msg, self)
