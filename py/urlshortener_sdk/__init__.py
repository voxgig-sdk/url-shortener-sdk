...
from urlshortener_sdk.utility import register

# Load features
from urlshortener_sdk.feature.base_feature import UrlShortenerBaseFeature
from urlshortener_sdk.features import _has_feature, _make_feature
...
class UrlShortenerSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = UrlShortenerUtility()
        self._utility = utility

        from urlshortener_sdk.config import shared_config
    ...
    def get_utility(self):
        return UrlShortenerUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UrlShortenerSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Index(self, data=None) -> "IndexEntity":
        ...
        from urlshortener_sdk.entity.index_entity import IndexEntity
        return IndexEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "UrlShortenerSDK":
        if sdkopts is None:
            sdkopts = {}
