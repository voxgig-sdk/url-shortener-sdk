# UrlShortener SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UrlShortenerSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UrlShortenerSDK(...) and UrlShortenerSDK.test(...) become
#      UrlShortenerSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "urlshortener_sdk"
_SDK_CLASS = "UrlShortenerSDK"
